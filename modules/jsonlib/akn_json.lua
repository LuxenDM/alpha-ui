--[[
This is a1k0n's library for converting between JSON string and lua table.
The code has been localized and formatted to work through Neoloader, but is otherwise left as is, including all the original commenting.

It is recommended to use rxi's json library instead of a1k0n's due to its cleaner design and faster processing.
]]--

local nullfunc = function() end

local encode = nullfunc
local decode = nullfunc
local null = nullfunc
local encodeString = nullfunc
local isArray = nullfunc
local isEncodable = nullfunc
...
-- original code above here

lib.set_class("json", "0.0.0 -a1k0n", json)