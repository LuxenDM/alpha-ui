--[[
a1k0n's json library, adapted to be entirely local and used through Neoloader.
Original commenting has not been removed.
]]--
...
lib.set_class("json", "1.0.0 -a1k0n", {	encode = encode, decode = decode, } )